...
export default {
  ...
  com_ui_pay_per_call: 'Digital Intelligence for the Built Environment',
  com_ui_new_footer: 'Digital Intelligence for the Built Environment',
  com_ui_enter: 'Enter',
  ...
  com_auth_welcome_back: 'BuiltData™ Login',
  ...
  com_nav_welcome_message: 'What would you like to know about your project(s)?',
